    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="input-group mb-3 col">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control validate-form" value="<?php echo $adm->display_name; ?>" id="xNome_C03"
                        name="xNome_C03">
            ...
            <div class="input-group mb-3 col">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control validate-form" maxlength="12" onkeypress="return apenasNumeros();"
        ...
        <div class="row">
            <div class="input-group mb-3 col">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control validate-form" onkeypress="return apenasNumeros();" id="cMun_C10"
                        name="cMun_C10">
