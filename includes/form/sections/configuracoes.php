...
<input type="hidden" class="validate-config" name="INDFINAL_B25A"
    value="<?php echo $configuracoes['INDFINAL_B25A']; ?>">
...
<input type="hidden" class="validate-config" name="vFCPSTRet_W06b"
    value="<?php echo $configuracoes['vFCPSTRet_W06b']; ?>">
...
<input type="hidden" class="validate-config" name="xContato_ZD04"
    value="<?php echo $configuracoes['xContato_ZD04']; ?>">
<input type="hidden" class="validate-config" name="assunto" value="<?php echo $configuracoes['assunto']; ?>">
<input type="hidden" class="validate-config" name="texto" value="<?php echo $configuracoes['texto']; ?>">
