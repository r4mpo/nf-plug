                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($nf_plug_admin->buscarCampoPersonalizadoEmPedidos($order->get_id(), 'situacao_nota_fiscal_plug') == 'Pendente') { ?>
                                <a href='../form/form.php?id=<?php echo base64_encode($order->get_id()) ?>'><button type="button" title="Emitir" class="btn btn-outline-primary"><i class="bi bi-file-earmark-text"></i></button>
                                </a>
                            ...
                            <?php } else { ?>
                                <a href="../form/pdf/<?php echo $nf_plug_admin->buscarCampoPersonalizadoEmPedidos($order->get_id(), 'pdf_nota_fiscal_plug'); ?>" target="_blank" rel="noopener noreferrer"><button type="button" title="Baixar PDF" class="btn btn-outline-danger"><i class="bi bi-filetype-pdf"></i></button></a>
                                <a href="../form/xml/<?php echo $nf_plug_admin->buscarCampoPersonalizadoEmPedidos($order->get_id(), 'xml_nota_fiscal_plug'); ?>" target="_blank" rel="noopener noreferrer" download="../form/xml/<?php echo $nf_plug_admin->buscarCampoPersonalizadoEmPedidos($order->get_id(), 'xml_nota_fiscal_plug'); ?>"><button type="button" title="Baixar XML" class="btn btn-outline-success"><i class="bi bi-filetype-xml"></i></button></a>
                                <button type="button" data-bs-toggle="modal" data-bs-target="#modalEmail" title="Enviar NF-e por e-mail" class="btn btn-outline-dark"><i class="bi bi-envelope-at"></i></button>
                            <?php } ?>
                        </td>
                    </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" id="campos_modal_form">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" class="form-control" name="chave_nf_plug" value="<?php echo $nf_plug_admin->buscarCampoPersonalizadoEmPedidos($order->get_id(), 'chave_nota_fiscal_plug'); ?>" id="chave_nf_plug">
                                        </div>
                                        <div class="mb-3">
                                            <label for="emailCliente" class="col-form-label">Endereços de e-mail separados
                                                por ",":</label>
                                            <textarea class="form-control" name="emailCliente" id="emailCliente"><?php echo $order->get_billing_email(); ?></textarea>
                                        </div>
                                    ...
                                    <div class="modal-footer" id="bloco-de-botoes">
                                        ...
                                        <button type="button" onclick="validarFormulario()" class="btn btn-primary">Confirmar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
